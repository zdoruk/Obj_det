...
if __name__ == "__main__":
    ...
    while True:
        ...
        if x==5:
            ...
            tespit_edilen_nesneler = {"Nesneler": icerik_listesi }
            with open ("tespit_edilen_nesneler.json","w") as dosya:
                json.dump(icerik_listesi,dosya)
            
            cv2.imwrite("tespit_edilen_objeler.jpg", img)
            print("Tespit edilen objeler resim dosyasına kaydedildi.")
            break
    cap.release()
